...
# Task 01: Calculate Number of Blocks
...
print("Previous hash code of Genesis block:", genesis_previous_hash)
print("Current hash code of Genesis block:", genesis_current_hash)
first_block_previous_hash = blockchain.chain[1]['previous_hash']
print("Previous hash code of 1st block:", first_block_previous_hash)
